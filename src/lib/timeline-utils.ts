...
export const ISLAMIC_HISTORY_PERIODS = [
  ...
  { year: 634, label: "Conquest of Damascus", description: "Siege of Damascus (Aug–Sep 634); Muslim armies capture Damascus, first major Byzantine city to fall", source: "https://en.wikipedia.org/wiki/Siege_of_Damascus_(634)", category: "expansion" as const },
  ...
  { year: 715, label: "Aden as Muslim Trading Port", description: "Aden (Yemen) becomes major Abbasid trading post linking India, East Africa, and the Hijaz", source: "https://en.wikipedia.org/wiki/Aden", category: "trade" as const },
  ...
  { year: 750, label: "Hormuz Trading Post", description: "Strait of Hormuz ports link Persian Gulf trade with India and East Africa; Muslim merchants dominate", source: "https://en.wikipedia.org/wiki/Hormuz_Island", category: "trade" as const },
  ...
  { year: 788, label: "Idris I Founds Morocco", description: "Idris I, descendant of Ali, flees Abbasids and establishes first Muslim dynasty in Morocco; Fes later becomes center of learning", source: "https://en.wikipedia.org/wiki/Idrisid_dynasty", category: "expansion" as const },
  ...
  { year: 900, label: "Sofala Trading Post", description: "Muslim traders establish Sofala (Mozambique); gold and ivory trade links interior Africa to Indian Ocean", source: "https://en.wikipedia.org/wiki/Sofala", category: "trade" as const },
  ...
  { year: 950, label: "Mombasa Trading Port", description: "Mombasa emerges as key Swahili trading port; links East Africa to Arabia and India", source: "https://en.wikipedia.org/wiki/History_of_Mombasa", category: "trade" as const },
  ...
  { year: 1099, label: "Al-Aqsa Desecrated", description: "Crusaders convert Al-Aqsa into Templar headquarters; mosque damaged and repurposed until 1187", source: "https://en.wikipedia.org/wiki/Al-Aqsa_Mosque#Crusader_period", category: "destruction" as const },
  ...
  { year: 1153, label: "Maldives Converts to Islam", description: "King Dhovemi converts to Islam, takes title Sultan Muhammad al-Adil; Buddhist temples converted to mosques (some sources give 1193)", source: "https://en.wikipedia.org/wiki/Islam_in_the_Maldives", category: "expansion" as const },
  ...
  { year: 1220, label: "Destruction of Bukhara & Samarkand Mosques", description: "Mongol armies raze major mosques and libraries in Bukhara and Samarkand; thousands killed", source: "https://en.wikipedia.org/wiki/Mongol_conquest_of_Khwarezmia", category: "destruction" as const },
  ...
  { year: 1258, label: "Destruction of Baghdad Mosques", description: "Hulagu's forces destroy Baghdad's mosques, libraries, and palaces; city devastated for generations", source: "https://en.wikipedia.org/wiki/Siege_of_Baghdad_(1258)", category: "destruction" as const },
  ...
  { year: 1291, label: "Fall of Acre", description: "Last Crusader stronghold falls; Mamluks restore Muslim control of coastal Palestine and its mosques", source: "https://en.wikipedia.org/wiki/Siege_of_Acre_(1291)", category: "era" as const },
  ...
  { year: 1973, label: "Gulf Labor Migration Boom", description: "Oil boom draws millions of South Asian and Arab workers to Gulf states; voluntary migration reshapes regional demographics", source: "https://en.wikipedia.org/wiki/Asian_workers_in_the_Arab_Gulf_states", category: "migration" as const },
  { year: 1975, label: "Lebanese Civil War Exodus", description: "Lebanese Muslims and Christians flee civil war; large diaspora to West Africa, Europe, and Americas", source: "https://en.wikipedia.org/wiki/Lebanese_diaspora", category: "migration" as const },
  { year: 1979, label: "Grand Mosque Seizure (Mecca)", description: "Juhayman al-Otaybi and militants seize Masjid al-Haram (20 Nov–4 Dec 1979); Saudi forces recapture with French GIGN advisory support; major impact on Saudi security policy", source: "https://en.wikipedia.org/wiki/Grand_Mosque_seizure", category: "era" as const },
  ...
  { year: 1992, label: "Babri Masjid Demolished", description: "Hindu nationalist mob demolishes 16th-century Babri Masjid in Ayodhya, India; triggers communal violence and long legal dispute", source: "https://en.wikipedia.org/wiki/Demolition_of_the_Babri_Masjid", category: "destruction" as const },
  ...
  { year: 1993, label: "Bosnia Mosques Destroyed", description: "Ferhadija Mosque (Banja Luka) and hundreds of Ottoman-era mosques destroyed during Bosnian War; many rebuilt after 2000", source: "https://en.wikipedia.org/wiki/Destruction_of_Bosnian_heritage", category: "destruction" as const },
  ...
  { year: 2014, label: "IS Destroys Mosques & Shrines", description: "Islamic State demolishes mosques and shrines in Iraq and Syria (e.g. Nabi Yunus, Imam Dur); targeting of religious heritage", source: "https://en.wikipedia.org/wiki/Destruction_of_cultural_heritage_by_ISIL", category: "destruction" as const },
  ...
  { year: 2017, label: "Great Mosque of al-Nuri Destroyed", description: "IS blows up the 12th-century al-Nuri Mosque and its leaning minaret in Mosul; symbol of the city lost", source: "https://en.wikipedia.org/wiki/Al-Nuri_Mosque,_Mosul", category: "destruction" as const },
