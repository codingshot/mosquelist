...
export const ISLAMIC_HISTORY_PERIODS = [
  ...
  { year: 1153, label: "Maldives Converts to Islam", description: "Sultan Muhammad al-Adil converts Maldives to Islam; Buddhist temples converted to mosques", source: "https://en.wikipedia.org/wiki/Islam_in_the_Maldives", category: "expansion" as const },
  ...
  { year: 1979, label: "Grand Mosque Seizure (Mecca)", description: "Juhayman al-Otaybi and militants seize Masjid al-Haram; two-week siege ends with Saudi and French recapture; major impact on Saudi security policy", source: "https://en.wikipedia.org/wiki/Grand_Mosque_seizure", category: "era" as const },
